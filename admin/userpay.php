                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #GMS_<?php echo(rand(100000,10000000));?> <br> 5021 Yewalewadi , Sinhagad Road ,Pune <br> </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By Rohit Denge</a> </div>
</div>
